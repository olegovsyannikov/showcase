...
return [
    'backup' => [
         ...
         * the backups.
         */
        'name' => \env('APP_NAME', 'soberone-backup'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => \env('BACKUP_MAIL_TO_ADDRESS', 'admin@getsober.one'),
            'from' => [
                'address' => \env('BACKUP_MAIL_FROM_ADDRESS', 'monitoring@getsober.one'),
                'name' => \env('BACKUP_MAIL_FROM_NAME', 'BackupsSystem'),
            ],
        ],
